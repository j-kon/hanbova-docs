# Hanbova Documentation

Central architecture, product, security, and developer documentation for the **Hanbova** payment ecosystem.
...
- [Roadmap](roadmap.md): Milestones 1 through 5 execution plan and current release-hardening status.
...
- [Release-Hardening Checklist](docs/release-hardening-checklist.md): Reproducible Flutter/Rust gates, deployment secrets, platform security, and branch integration checks.
