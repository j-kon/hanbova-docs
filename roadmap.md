...
- **UI/platform:** the English localization foundation, native sensitive-screen protections, Android backup exclusions, and account-scoped profile persistence are integrated. The broad 48dp/text-scale audit and reproducible iOS framework packaging remain release gates; track them in the [release-hardening checklist](docs/release-hardening-checklist.md).
